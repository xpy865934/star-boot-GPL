...
//        tableFillList.add(new TableFill("ASDD_SS", FieldFill.INSERT_UPDATE));
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("xpy778899")
                        .setUrl("jdbc:mysql://120.78.198.144:3306/star?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        ...
                        // 自定义实体父类
                         .setSuperEntityClass("com.star.starboot.common.entity.AbstractEntity")
                        // 自定义实体，公共字段
                        .setSuperEntityColumns(new String[]{"PROCESS_STATE","CREATE_BY","CREATE_AT","UPDATE_BY",
                                "UPDATE_AT","DELETED_AT","DELETED_BY","DELETED_CODE"})
                        ...
                        // 自定义 controller 父类
                        .setSuperControllerClass("com.star.starboot.common.controller.AbstractController")
