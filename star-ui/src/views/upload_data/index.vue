      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item title="机构配置信息" name="1">
          <el-form-item label="全日制ICU专科医师数">
            <el-input v-model.number="form.icuZkys" />
          </el-form-item>
          <el-form-item label="ICU床位数">
            <el-input v-model.number="form.icuCws" />
          </el-form-item>
          <el-form-item label="ICU护士总数">
            <el-input v-model.number="form.icuHszs" />
          </el-form-item>
          <el-form-item label="医院总床位数">
            <el-input v-model.number="form.yyzcws" />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="患者收治情况" name="2">
          <el-form-item label="ICU原有病人数">
            <el-input v-model.number="form.icuYybrs" />
          </el-form-item>
          <el-form-item label="ICU新收治病人数">
            <el-input v-model.number="form.icuXszbrs" />
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item label="医院原有病人数">
            <el-input v-model.number="form.yyYsbrs" />
          </el-form-item>
          <el-form-item label="医院新收治病人数">
            <el-input v-model.number="form.yyXszbrs" />
          </el-form-item>
          ...
          <el-form-item label="入ICU24小时内，APACHE Ⅱ评分 ≥ 15分患者">
            <el-input v-model.number="form.apacheHzs" />
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item label="ICU患者收治总床日数">
            <el-input v-model.number="form.icuHzszzcrs" />
          </el-form-item>
          <el-form-item label="医院收治患者总床日数">
            <el-input v-model.number="form.yySzzcrs" />
          </el-form-item>
          <el-form-item label="">
        ...
        <el-collapse-item title="Sepsis" name="3">
          <el-form-item label="入ICU诊断为Sepsis患者总数">
            <el-input v-model.number="form.sepsisHzzs" />
          </el-form-item>
          <el-form-item label="全部完成3h bundle的患者数">
            <el-input v-model.number="form.tbundleHzs" />
          </el-form-item>
          <el-form-item label="全部完成6h bundle的患者数">
            <el-input v-model.number="form.sbundleHzs" />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="抗菌药物" name="4">
          <el-form-item label="治疗性抗菌药物病例总数">
            <el-input v-model.number="form.kjysblzs" />
          </el-form-item>
          <el-form-item label="使用抗菌药物前病原学检验标本送检例数">
            <el-input v-model.number="form.kjywsjls" />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="DVT" name="5">
          <el-form-item label="采取药物预防、非药物预防DVT措施的病例总数">
            <el-input v-model.number="form.dvtblzs" />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="患者病死率" name="6">
          <el-form-item label="临床死亡人数">
            <el-input v-model.number="form.lcswrs" />
          </el-form-item>
          <el-form-item label="自动出院人数">
            <el-input v-model.number="form.zdcyrs" />
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item label="ICU收治患者入ICU预计病死率之和">
            <el-input v-model="form.icuYjbslzh" v-enterNumber />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="非计划转入和重返事件" name="7">
          <el-form-item label="非计划转入ICU患者数（术后）">
            <el-input v-model.number="form.fjhIcuHzs" />
          </el-form-item>
          <el-form-item label="转入ICU患者总数（术后）">
            <el-input v-model.number="form.zrIcuHzs" />
          </el-form-item>
          <el-form-item label="转出ICU后48h内重返ICU患者数">
            <el-input v-model.number="form.cfIcuHzs" />
          </el-form-item>
          <el-form-item label="ICU转出患者总数">
            <el-input v-model.number="form.zcIcuHzs" />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="气管插管事件" name="8">
          <el-form-item label="非计划气管插管脱出次数">
            <el-input v-model.number="form.fjhTccs" />
          </el-form-item>
          <el-form-item label="ICU患者气管插管总例数">
            <el-input v-model.number="form.icuCgzls" />
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item label="计划拔管后48h内再插管例数">
            <el-input v-model.number="form.zcgls" />
          </el-form-item>
          <el-form-item label="ICU患者气管插管拔管总例数(不包括非计划拔管患者)">
            <el-input v-model.number="form.icuBgzls" />
          </el-form-item>
          <el-form-item>
        ...
        <el-collapse-item title="三管感染率" name="9">
          <el-form-item label="ICU呼吸机相关肺炎病人总例数">
            <el-input v-model.number="form.icuFybrzls" />
          </el-form-item>
          <el-form-item label="ICU总机械通气天数">
            <el-input v-model.number="form.icuTqts" />
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item label="ICU中心静脉导管相关性血流感染总例数">
            <el-input v-model.number="form.icuXlglzls" />
          </el-form-item>
          <el-form-item label="ICU中心静脉导管总天数">
            <el-input v-model.number="form.icuJmdgzts" />
          </el-form-item>
          <el-form-item>
          ...
          <el-form-item label="ICU导尿管相关泌尿系统感染总例数">
            <el-input v-model.number="form.icuMnglzls" />
          </el-form-item>
          <el-form-item label="ICU尿管留置总天数">
            <el-input v-model.number="form.icuNglzzts" />
          </el-form-item>
          <el-form-item>
